...
if(error === "YES"){
	...
	var html="<div class='alert alert-warning alert-block fade in container' id='dangerAlert'><button type='button' class='close' data-dismiss='alert'>&times;</button><h4>Ya esta inscrito en este curso.</h4>";
	$(".article").prepend(html);
}
